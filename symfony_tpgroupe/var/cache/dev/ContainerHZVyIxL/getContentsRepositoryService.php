 ...
 */
class getContentsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ContentsRepository' shared autowired service.
     *
     * @return \App\Repository\ContentsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ContentsRepository.php';

        return $container->privates['App\\Repository\\ContentsRepository'] = new \App\Repository\ContentsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
